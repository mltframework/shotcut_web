...
1. Download and install the following:
  ...
  - Qt SDK version 6.7 MinGW  
    If your Qt installer no longer includes this you can [get it from our S3 bucket](https://s3.amazonaws.com/misc.meltymedia/shotcut-build/qt-6.7.2-x64-mingw.txz), and
    extract this alongside your other Qt versions, for example `C:\Qt`.  
    (You can get `tar` and `xz` needed to extract this from `msys2`.)
  - [Shotcut SDK (1.0 GB current version 24.11.17)](https://s3.amazonaws.com/builds.us.meltytech/shotcut/shotcut-win64-sdk-241117.txz)  
